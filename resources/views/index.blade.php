...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Karizma - Modern vCard / Resume / CV / Portfolio</title>
                        ...
                        <div class="display-table-cell">
                            ...
                            <div class="more_info">
                                ...
                                <div class="item">
                                    ...
                                    <span class="info-body">27 Years</span>
                                </div>

                                <div class="item">
                                    <span class="info-title">Date of birth : </span>
                                    <span class="info-body">15-02-1991</span>
                                </div>

                                <div class="item">
                                    <span class="info-title">Address : </span>
                                    <span class="info-body">Front Street, Mexico Us</span>
                                </div>

                                <div class="item">
                                    <span class="info-title">E-mail : </span>
                                    <span class="info-body">email@example.com</span>
                                </div>

                                <div class="item">
                                    <span class="info-title">Phone : </span>
                                    <span class="info-body">+0123 123 456 789</span>
                                </div>
                        ...
                        <div class="testimonials margin-top-45">
                            ...
                            <div class="owl">
                                ...
                                <div class="testimonial">
                                    ...
                                    <img src="{{asset('images/testimonials/client_1.jpg')}}" alt="">
                                    <h4>John Doe</h4>
                                    <h5>Client</h5>
                                </div>
                                ...
                                <div class="testimonial">
                                    ...
                                    <img src="{{asset('images/testimonials/client_2.jpg')}}" alt="">
                                    <h4>John Doe</h4>
                                    <h5>Client</h5>
                                </div>
                                ...
                                <div class="testimonial">
                                    ...
                                    <img src="{{asset('images/testimonials/client_3.jpg')}}" alt="">
                                    <h4>John Doe</h4>
                                    <h5>Client</h5>
                                </div>
                                ...
                                <div class="testimonial">
                                    ...
                                    <img src="{{asset('images/testimonials/client_4.jpg')}}" alt="">
                                    <h4>John Doe</h4>
                                    <h5>Client</h5>
                                </div>
                        ...
                        <div class="row grid">
                            ...
                            <div class="col-xs-12 col-sm-6 item grid-sizer design">
                                <div class="project_content">
                                    <div class="my_img">
                                        <img src="{{asset('images/portfolio/work-1.jpg')}}" alt=''>
                                    </div>
                                    <div class="info">
                                        <div class="display-table">
                                            <div class="display-table-cell">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="project__slider">
                                                    <ul class="project-slider">
                                                        ...
                                                        <!-- image 1 -->
                                                        <li>
                                                            <img src="{{asset('images/portfolio/work-2.jpg')}}" alt="">
                                                        </li>

                                                        <!-- image 2 -->
                                                        <li>
                                                            <img src="{{asset('images/portfolio/work-3.jpg')}}" alt="">
                                                        </li>

                                                        <!-- image 3 -->
                                                        <li>
                                                            <img src="{{asset('images/portfolio/work-4.jpg')}}" alt="">
                                                        </li>
                                                ...
                                                <img src="{{asset('images/portfolio/work-5.jpg')}}" alt="" class="margin-top-45">
                            ...
                            <div class="col-xs-12 col-sm-6 item coding">
                                <div class="project_content">
                                    <div class="my_img" data-mfp-src="{{asset('images/portfolio/work-2.jpg')}}">
                                        <img src="{{asset('images/portfolio/work-2.jpg')}}" alt=''>
                                    </div>
                                    <div class="info">
                                        <div class="display-table">
                            ...
                            <div class="col-xs-12 col-sm-6 item logo">
                                <div class="project_content">
                                    <div class="my_img">
                                        <img src="{{asset('images/portfolio/work-5.jpg')}}" alt=''>
                                    </div>
                                    <div class="info">
                                        <div class="display-table">
                                            <div class="display-table-cell">
                            ...
                            <div class="col-xs-12 col-sm-6 item coding">
                                <div class="project_content">
                                    <div class="my_img" data-mfp-src="{{asset('images/portfolio/work-6.jpg')}}">
                                        <img src="{{asset('images/portfolio/work-6.jpg')}}" alt=''>
                                    </div>
                                    <div class="info">
                                        <div class="display-table">
                                            <div class="display-table-cell">
                            ...
                            <div class="col-sm-6">
                                <div class="item margin-b-zero">
                                    <a href="#">
                                        <div class="blog__img">
                                            <i class="pe-7s-news-paper"></i>
                                            <img src="{{asset('images/blog/blog-5.jpg')}}" alt="">
                                        </div>
                                    </a>
                                    <div class="content matchH">
                                        <p class="info">March 19, 2018</p>
                            ...
                            <div class="col-sm-6">
                                <div class="item margin-b-zero">
                                    <a href="#">
                                        <div class="blog__img">
                                            <i class="pe-7s-news-paper"></i>
                                            <img src="{{asset('images/blog/blog-6.jpg')}}" alt="">
                                        </div>
                                    </a>
                                    <div class="content matchH">
                                        <p class="info">March 19, 2018</p>
